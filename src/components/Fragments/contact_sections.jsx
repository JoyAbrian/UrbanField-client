        ...
        <div className="w-full h-fit mt-20">
            ...
            <div className="flex">
                <div className="w-1/2 h-96 flex justify-center items-center">
                    <img src="img/icon.png" className="w-40"/>
                </div>
                    ...
                    <div className="font-DM_Sans text-lg">
                        ...
                        <div className="flex w-full justify-between mt-12">
                            ...
                            <div className="flex items-center justify-between gap-4">
                                <img src="img/social/facebook.png" className="w-7"/>
                                <img src="img/social/twitter.png" className="w-7"/>
                                <img src="img/social/linkedin.png" className="w-7"/>
                                <img src="img/social/youtube.png" className="w-7"/>
                                <img src="img/social/instagram.png" className="w-7"/>
                                <img src="img/social/google.png" className="w-7"/>
                                <img src="img/social/pinterest.png" className="w-7"/>
                                <img src="img/social/network.png" className="w-7"/>
                            </div>
                        </div>
                    </div>
                </div>
